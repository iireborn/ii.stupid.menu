...
namespace iiMenu.Extensions
{
    public static class VRRigExtensions
    {
        ...
        /// <summary>
        /// The rig's entire owned inventory as one dot-delimited string, e.g. "LBAAK.LBAGS.LBANI.LMAPY.".
        /// Every '.' terminates a single cosmetic id, so the value can be split back apart with
        /// CosmeticsUtilities.ParseCosmeticsString.
        /// </summary>
        public static string OwnedCosmeticsString(this VRRig rig) =>
            rig == null ? string.Empty : CosmeticsUtilities.SerializeOwnedCosmetics(rig._playerOwnedCosmetics);
